"""Kling 2.6 Motion Control Pro — video/kling-v2-6-motion-control-pro
Docs: https://docs.freepik.com/api-reference/video/kling-v2-6-motion-control-pro
...
async def list_tasks(api_key: str) -> dict:
    ...
    logger.info("[kling_2_6_motion_pro] Listing all tasks")
