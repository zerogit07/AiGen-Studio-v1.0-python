"""Kling V3 Pro — video/kling-v3-pro
Docs: https://docs.freepik.com/api-reference/video/kling-v3/generate-pro
...
async def list_tasks(api_key: str) -> dict:
    ...
    logger.info("[kling_v3_pro] Listing all tasks")
...
async def get_task(task_id: str, api_key: str) -> dict:
    ...
    logger.info("[kling_v3_pro] Getting task status: %s", task_id)
    return await request_engine(method="GET", url=url, force_api_key=api_key)
