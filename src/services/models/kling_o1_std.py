"""Kling O1 Standard — image-to-video/kling-o1-std
Docs: https://docs.freepik.com/api-reference/image-to-video/kling-o1-std
      https://docs.freepik.com/api-reference/image-to-video/kling-o1-std-video-reference
...
ENDPOINT_VIDEO_REF = "image-to-video/kling-o1-std-video-reference"
...
async def create_task(params, send_request) -> dict:
    ...
    or POST /v1/ai/image-to-video/kling-o1-std-video-reference (reference mode)
    """
    ratio_map = {
...
async def list_tasks(api_key: str) -> dict:
    ...
    logger.info("[kling_o1_std] Listing all tasks")
