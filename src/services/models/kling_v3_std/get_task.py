"""GET Task by ID — video/kling-v3/{task_id}
Docs: https://docs.freepik.com/api-reference/video/kling-v3/task-by-id
...
async def get_task(task_id: str, api_key: str) -> dict:
    ...
    logger.info("[kling_v3_std] Getting task status: %s", task_id)
