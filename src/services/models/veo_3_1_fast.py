"""Veo 3.1 Fast — text-to-video/veo-3-1-fast & image-to-video/veo-3-1-fast
Docs: https://docs.freepik.com/api-reference/text-to-video/post-veo-3-1-fast
      https://docs.freepik.com/api-reference/image-to-video/post-veo-3-1-fast
...
ENDPOINT_TEXT = "text-to-video/veo-3-1-fast"
ENDPOINT_IMAGE = "image-to-video/veo-3-1-fast"
STATUS_PATH_TEXT = "text-to-video/veo-3-1-fast"
STATUS_PATH_IMAGE = "image-to-video/veo-3-1-fast"
DURATIONS = ["4", "6", "8"]


async def create_task(params, send_request) -> dict:
    """POST /v1/ai/text-to-video/veo-3-1-fast
    or POST /v1/ai/image-to-video/veo-3-1-fast (with image)
    """
    ratio_map = {
