...
MODEL_CONFIG: dict[str, ModelConfig] = {
    "kling_v3": ModelConfig(
        endpoint="text-to-video/kling-v3-pro",
        status_path="text-to-video/kling-v3",
        needs_duration=True,
        durations=["3", "5", "7", "10", "12", "15"],
    ),
    "kling_v3_motion": ModelConfig(
        endpoint="video-generation/kling-v3-motion-control-pro",
        status_path="video-generation/kling-v3-motion-control-pro",
        needs_duration=False,
        needs_orientation=True,
    ),
    "kling_v3_omni": ModelConfig(
        endpoint="text-to-video/kling-v3-omni-pro",
        status_path="text-to-video/kling-v3-omni",
        needs_duration=False,
    ),
    ...
    "kling_v3_std": ModelConfig(
        endpoint="text-to-video/kling-v3-std",
        status_path="text-to-video/kling-v3",
        needs_duration=True,
        durations=["3", "5", "7", "10", "12", "15"],
    ),
    ...
    "kling_v3_motion_std": ModelConfig(
        endpoint="video-generation/kling-v3-motion-control-std",
        status_path="video-generation/kling-v3-motion-control-std",
        needs_duration=False,
        needs_orientation=True,
    ),
    ...
    "kling_v3_omni_std": ModelConfig(
        endpoint="text-to-video/kling-v3-omni-std",
        status_path="text-to-video/kling-v3-omni",
        needs_duration=False,
    ),
    ...
    "kling_2_6_motion": ModelConfig(
        endpoint="video-generation/kling-v2-6-motion-control-pro",
        status_path="image-to-video/kling-v2-6",
        needs_duration=False,
        needs_orientation=True,
    ),
    ...
    "kling_2_6_motion_std": ModelConfig(
        endpoint="video-generation/kling-v2-6-motion-control-std",
        status_path="image-to-video/kling-v2-6",
        needs_duration=False,
        needs_orientation=True,
    ),
    ...
    "kling_2_1_pro": ModelConfig(
        endpoint="text-to-video/kling-v2-1-pro",
        status_path="text-to-video/kling-v2-1-pro",
        needs_duration=True,
        needs_aspect_ratio=True,
        durations=["5", "10"],
    ),
    "kling_2_1": ModelConfig(
        endpoint="text-to-video/kling-v2-1-std",
        status_path="text-to-video/kling-v2-1-std",
        needs_duration=True,
        durations=["5", "10"],
    ),
